...
// m61_realloc (ptr, file, line)
//does the job as described in the pset description (hopefully) and that description is copied into the 
//main .cc file if you are interested in looking at that. 
